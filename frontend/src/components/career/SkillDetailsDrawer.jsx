...
export const SkillDetailsDrawer = ({ skillNode, onClose, onVerifySkill }) => {
  ...
  return (
    <div className="fixed inset-y-0 right-0 z-50 w-full sm:w-[440px] bg-[var(--card-surface)] border-l border-[var(--border-line)] shadow-2xl p-6 overflow-y-auto flex flex-col justify-between font-editorial-mono animate-in slide-in-from-right duration-200 text-[var(--text-primary)]">
